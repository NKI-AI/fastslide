...
** Note **: This is a stripped, and (slightly) rerwritten version of [jpgd.cpp](https://github.com/richgel999/jpeg-compressor) using [Highway](https://github.com/google/highway) for the IDCT transform and for some color transforms. A build file for Bazel and for meson is provided. Below is the original README.
