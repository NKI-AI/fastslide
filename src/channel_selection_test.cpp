...
/// @details Reuses `MinimalSlideReader` defaults; only overrides what the
///          channel-selection tests actually inspect.
class MockReaderForChannelSelection : public testing::MinimalSlideReader {
 public:
