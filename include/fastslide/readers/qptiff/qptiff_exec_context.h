...
#ifndef AIFO_FASTSLIDE_INCLUDE_FASTSLIDE_READERS_QPTIFF_QPTIFF_EXEC_CONTEXT_H_
#define AIFO_FASTSLIDE_INCLUDE_FASTSLIDE_READERS_QPTIFF_QPTIFF_EXEC_CONTEXT_H_
...
/// @brief Read-only view of QPTIFF state needed by the tile executor.
class QptiffExecContext {
 public:
  QptiffExecContext(std::string_view filename,
  ...
  [[nodiscard]] std::span<const QpTiffLevelInfo> GetPyramid() const {
    return pyramid_;
  }
 ...
 private:
  ...
  std::span<const QpTiffLevelInfo> pyramid_;
...
#endif  // AIFO_FASTSLIDE_INCLUDE_FASTSLIDE_READERS_QPTIFF_QPTIFF_EXEC_CONTEXT_H_
