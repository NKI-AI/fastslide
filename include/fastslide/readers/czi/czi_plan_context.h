...
/// @brief Read-only view of CZI state needed by the plan builder.
struct CziPlanContext {
  int level_count = 0;
...
#endif  // AIFO_FASTSLIDE_INCLUDE_FASTSLIDE_READERS_CZI_CZI_PLAN_CONTEXT_H_
