...
#ifndef AIFO_FASTSLIDE_INCLUDE_FASTSLIDE_READERS_DICOM_DICOM_TILE_EXECUTOR_H_
#define AIFO_FASTSLIDE_INCLUDE_FASTSLIDE_READERS_DICOM_DICOM_TILE_EXECUTOR_H_
...
/// @brief Tile executor for DICOM WSI (two-stage pipeline stage 2).
///
/// Reads frames via libdicom and decodes them based on the DICOM transfer
/// syntax (JPEG, JPEG 2000, or uncompressed RGB).
...
#endif  // AIFO_FASTSLIDE_INCLUDE_FASTSLIDE_READERS_DICOM_DICOM_TILE_EXECUTOR_H_
