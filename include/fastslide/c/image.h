...
FASTSLIDE_API FastSlideImage* fastslide_image_create_rgb(
...
/// @param data_type Data type
/// @return Image handle or NULL on failure
FASTSLIDE_API FastSlideImage* fastslide_image_create_rgba(
    FastSlideImageDimensions dimensions, FastSlideDataType data_type);
...
/// @param data_type Data type
/// @return Image handle or NULL on failure
FASTSLIDE_API FastSlideImage* fastslide_image_create_grayscale(
    FastSlideImageDimensions dimensions, FastSlideDataType data_type);
...
/// @param data_type Data type
/// @return Image handle or NULL on failure
FASTSLIDE_API FastSlideImage* fastslide_image_create_spectral(
...
FASTSLIDE_API FastSlideImage* fastslide_image_create_blank(
...
FASTSLIDE_API FastSlideImage* fastslide_image_create_solid_color(
    FastSlideImageDimensions dimensions, FastSlideDataType data_type,
...
FASTSLIDE_API int fastslide_image_get_info(const FastSlideImage* image,
...
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_image_get_dimensions(
    const FastSlideImage* image, FastSlideImageDimensions* dimensions);

/// @brief Get image width
/// @param image Image handle
/// @return Image width or 0 on failure
FASTSLIDE_API uint32_t fastslide_image_get_width(const FastSlideImage* image);

/// @brief Get image height
/// @param image Image handle
/// @return Image height or 0 on failure
FASTSLIDE_API uint32_t fastslide_image_get_height(const FastSlideImage* image);

/// @brief Get number of channels
/// @param image Image handle
/// @return Number of channels or 0 on failure
FASTSLIDE_API uint32_t
fastslide_image_get_channels(const FastSlideImage* image);

/// @brief Get image format
/// @param image Image handle
/// @return Image format
FASTSLIDE_API FastSlideImageFormat
fastslide_image_get_format(const FastSlideImage* image);

/// @brief Get data type
/// @param image Image handle
/// @return Data type
FASTSLIDE_API FastSlideDataType
fastslide_image_get_data_type(const FastSlideImage* image);

/// @brief Get planar configuration
/// @param image Image handle
/// @return Planar configuration
FASTSLIDE_API FastSlidePlanarConfig
fastslide_image_get_planar_config(const FastSlideImage* image);

/// @brief Get bytes per sample
/// @param image Image handle
/// @return Bytes per sample or 0 on failure
FASTSLIDE_API size_t
fastslide_image_get_bytes_per_sample(const FastSlideImage* image);

/// @brief Check if image is empty
/// @param image Image handle
/// @return 1 if empty, 0 if not empty or on failure
FASTSLIDE_API int fastslide_image_is_empty(const FastSlideImage* image);

/// @brief Check if image is initialized
/// @param image Image handle
/// @return 1 if initialized, 0 if not initialized or on failure
FASTSLIDE_API int fastslide_image_is_initialized(const FastSlideImage* image);

/// @brief Get total size in bytes
/// @param image Image handle
/// @return Total size in bytes or 0 on failure
FASTSLIDE_API size_t
fastslide_image_get_size_bytes(const FastSlideImage* image);

/// @brief Get total number of pixels
/// @param image Image handle
/// @return Total number of pixels or 0 on failure
FASTSLIDE_API size_t
fastslide_image_get_pixel_count(const FastSlideImage* image);
...
FASTSLIDE_API const uint8_t* fastslide_image_get_data(
    const FastSlideImage* image);

/// @brief Get mutable raw data pointer
/// @param image Image handle
/// @return Pointer to raw data or NULL on failure
FASTSLIDE_API uint8_t* fastslide_image_get_data_mutable(FastSlideImage* image);
...
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_image_copy_data(const FastSlideImage* image,
                                            uint8_t* buffer,
                                            size_t buffer_size);
...
FASTSLIDE_API FastSlideImage* fastslide_image_extract_channels(
...
FASTSLIDE_API FastSlideImage* fastslide_image_clone(
    const FastSlideImage* image);
...
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_image_paste(FastSlideImage* dest_image,
...
FASTSLIDE_API int fastslide_image_get_description(const FastSlideImage* image,
                                                  char* buffer,
                                                  size_t buffer_size);
...
/// @param image Image handle
FASTSLIDE_API void fastslide_image_free(FastSlideImage* image);
