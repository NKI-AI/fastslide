...
FASTSLIDE_API int fastslide_slide_reader_get_level_count(
...
FASTSLIDE_API int fastslide_slide_reader_get_level_info(
    const FastSlideSlideReader* reader, int level, FastSlideLevelInfo* info);
...
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_slide_reader_get_level_dimensions(
...
/// @param dimensions Output dimensions
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_slide_reader_get_base_dimensions(
...
FASTSLIDE_API double fastslide_slide_reader_get_level_downsample(
    const FastSlideSlideReader* reader, int level);
...
FASTSLIDE_API int fastslide_slide_reader_get_best_level_for_downsample(
...
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_slide_reader_get_properties(
...
FASTSLIDE_API void fastslide_slide_reader_free_properties(
...
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_slide_reader_get_bounds(
    const FastSlideSlideReader* reader, FastSlideBounds* bounds);

/// @brief Get format name
/// @param reader Slide reader handle
/// @return Format name string or NULL on failure
/// (pointer valid until reader is freed)
FASTSLIDE_API const char* fastslide_slide_reader_get_format_name(
    const FastSlideSlideReader* reader);
...
fastslide_slide_reader_get_image_format(const FastSlideSlideReader* reader);

/// @brief Get tile size
/// @param reader Slide reader handle
/// @param tile_size Output tile size
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_slide_reader_get_tile_size(
    const FastSlideSlideReader* reader, FastSlideImageDimensions* tile_size);
...
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_slide_reader_get_channel_metadata(
...
FASTSLIDE_API FastSlideImage* fastslide_slide_reader_read_region(
...
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_slide_reader_get_associated_image_names(
...
FASTSLIDE_API void fastslide_slide_reader_free_associated_image_names(
...
/// @param dimensions Output dimensions
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_slide_reader_get_associated_image_dimensions(
...
/// @param name Associated image name
/// @return Image handle or NULL on failure
FASTSLIDE_API FastSlideImage* fastslide_slide_reader_read_associated_image(
    const FastSlideSlideReader* reader, const char* name);
...
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_slide_reader_get_metadata_keys(
    const FastSlideSlideReader* reader, char*** keys, int* num_keys);

/// @brief Free metadata keys
/// @param keys Keys array
/// @param num_keys Number of keys
FASTSLIDE_API void fastslide_slide_reader_free_metadata_keys(char** keys,
                                                             int num_keys);
...
/// @return 1 on success, 0 on failure
FASTSLIDE_API int fastslide_slide_reader_get_metadata_value(
...
FASTSLIDE_API FastSlidePropertyType fastslide_slide_reader_get_metadata_type(
    const FastSlideSlideReader* reader, const char* key);
...
FASTSLIDE_API int fastslide_slide_reader_is_region_valid(
    const FastSlideSlideReader* reader, const FastSlideRegionSpec* region);
...
/// @param reader Slide reader handle
FASTSLIDE_API void fastslide_slide_reader_free(FastSlideSlideReader* reader);
